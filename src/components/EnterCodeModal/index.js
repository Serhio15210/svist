    ...
    <Modal
      ...
      <View style={styles.container}>
        ...
        <View style={{
          ...
          {invalidCode && <Text
            style={styles.invalidCodeText} adjustsFontSizeToFit={true} numberOfLines={1}>Invalid code, please try again.</Text>}

          <View style={styles.modalBlock}>
            <Text style={styles.title}>Scan error. Please try again.</Text>
            <Text style={styles.text}>Scooter ready! Enter code)
              (code written on the steering wheel)</Text>
